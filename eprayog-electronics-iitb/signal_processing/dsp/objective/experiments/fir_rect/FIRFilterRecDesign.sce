...
//////////////////////// Calculate Reac Window Parameters ////////////////////
function Para_Ret = GetReacWinowPara(d1,d2,delw) 
...
///////////////////////////////////////////////////////////////////////////////
//////////////  Design filters using Reac window.///////////////////////////
...
ReacPara = GetReacWinowPara(d1,d2,TransWidth);
A = ReacPara(1); 
FilterOrder = ReacPara(2); 
Alpha = CalcAlpha(A);
Beta = (Alpha/FilterOrder);
/////////////////////// filter Design///////////////////////////////////
Window = window('re',(2*FilterOrder) + 1,Alpha );
...
HReac = DesignFilter('BandPass',FilterOrder,CutOffFreq1,CutOffFreq2,Window);

subplot(121);plot2d(1:(2*FilterOrder) + 1,Window,style=color('blue'))
set(gca(),'grid',[1 1]*color('gray'))
subplot(122)
n=256;[W,fr]=frmag(HReac,n);
