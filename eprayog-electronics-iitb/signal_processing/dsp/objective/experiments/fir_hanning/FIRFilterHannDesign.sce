...
function Para_Ret = GetWindowPara(d1,d2,delw) 
...
///////////////////////////////////////////////////////////////////////////////
//////////////  Design filters using Hann window.///////////////////////////
...
HannPara = GetWindowPara(d1,d2,TransWidth);
A = HannPara(1); 
FilterOrder = HannPara(2); 
Alpha = CalcAlpha(A);
Beta = (Alpha/FilterOrder);
/////////////////////// filter Design///////////////////////////////////
Window = window('hn',(2*FilterOrder) + 1,Alpha );
...
HHann = DesignFilter('BandPass',FilterOrder,CutOffFreq1,CutOffFreq2,Window);

subplot(121);plot2d(1:(2*FilterOrder) + 1,Window,style=color('blue'))
set(gca(),'grid',[1 1]*color('gray'))
subplot(122)
n=256;[W,fr]=frmag(HHann,n);
